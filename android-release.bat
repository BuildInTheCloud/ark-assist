...
IF %ERRORLEVEL% == 0 (
    ...
    call "%ANDROID_HOME%\build-tools\24.0.3\zipalign.exe" -v 4 platforms\android\build\outputs\apk\android-armv7-release-unsigned.apk platforms\android\build\outputs\apk\android-armv7-release-signed.apk
    call "%ANDROID_HOME%\build-tools\24.0.3\zipalign.exe" -v 4 platforms\android\build\outputs\apk\android-x86-release-unsigned.apk platforms\android\build\outputs\apk\android-x86-release-signed.apk
)
